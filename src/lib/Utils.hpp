...
class Utils
{
  public:
    ...
    static void input_validate(Type&& var, int lower, int upper)
    {
        std::cout << "> ";
        std::string temp;
        while (!(std::cin >> std::ws >> var) || var < lower || var > upper) {
    ...
    {
        std::cout << "\n";
        // std::cout << " _    _   _____   _       _____   _____   __  __ _____
        // _____   _____     _____   _____   _____   __  __    ___    _____   _
        // _    ___    _   _     _   __   ___    _____   _____   _   _  " <<
        // std::endl; std::cout << "| |  | | |  ___| | |     /  __ \\ |  _  | |
        // \\/  | |  ___|   |_   _| |  _  |   | ___ \\ |  ___| | ___ \\ |  \\/
        // |  / _ \\  |_   _| | \\ | |  / _ \\  | \\ | |   | | / /  / _ \\  |
        // ___ \\ |_   _| | | | | " << std::endl; std::cout << "| |  | | | |__
        // | |     | /  \\/ | | | | | .  . | | |__       | |   | | | |   | |_/ /
        // | |__   | |_/ / | .  . | / /_\\ \\   | |   |  \\| | / /_\\ \\ |  \\|
        // |   | |/ /  / /_\\ \\ | |_/ /   | |   | | | | " << std::endl;
        // std::cout << "| |/\\| | |  __|  | |     | |     | | | | | |\\/| | |
        ...
        // \\_/    \\___/  " << std::endl;
        std::cout << "\e[0;95mWelcome To Permainan Kartu Kerajaan Permen\e[0m"
                  << std::endl;
        std::cout << "\n";
    }
};
