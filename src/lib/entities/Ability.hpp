...
class Ability
{
  ...
  protected:
    GameManager& game;
    Player<CardColor,CardNumber>* owner;
  ...
  public:
    ...
    Player<CardColor,CardNumber>* getOwner();
    ...
    void setOwner(Player<CardColor,CardNumber>* player);
    bool isMuted() const;
    bool isUsed() const;
};
...
class SwapCard : public Ability
{
  public:
    ...
    void useAbility(Player<CardColor,CardNumber>&, Player<CardColor,CardNumber>&, int, int);
...
class SwitchCard : public Ability
{
  public:
    ...
    void useAbility(Player<CardColor,CardNumber>&);
